...
export default function OrderLookupItem({
  time,
  quantity,
  menu,
  price,
  ...
  return (
    ...
    >
      ...
      <div className="flex cursor-pointer justify-center items-center w-40 h-40 gap-2.5 mx-7 py-[15px] rounded-[10px] bg-[#435fff] border border-black text-[40px] font-bold text-center text-white">
        주문표 상세
      </div>
    </div>
  );
